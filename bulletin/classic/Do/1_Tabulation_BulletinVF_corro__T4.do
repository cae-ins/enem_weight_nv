...
global Pilote_Analyse    = "E:\INS_CAE_ISE\Tendance_T4\Bulletin_Trimestriel"
...
*do "${Do}\Codification.do" // à remettre quand les elements sur la codification seront au point
...
replace poids_men_vf = 1 // a actualisé quand les ponderations seront effectués
...
/* Milieu de résidence */
total i.PAT [pw=poids_men_vf] if trimestre =="T4" , over(milieu_resid2)  
mat list e(b)
...
/* Sexe */
mat RESU_ = RESU_ \ (.)
total i.PAT [pw=poids_men_vf] if trimestre =="T4", over(sexe) 
mat list e(b)
mat RESU_ = RESU_ \ (r(table)[rownumb(r(table),"b"),3..4]')

/* Niveau d'instruction */
mat RESU_ = RESU_ \ (.)
total i.PAT [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU_ = RESU_ \ (r(table)[rownumb(r(table),"b"),6..10])'

/* Ensemble */
total i.PAT [pw=poids_men_vf] if trimestre =="T4"
mat list e(b)
...
/* Milieu de résidence */
proportion milieu_resid2  [pw=poids_men_vf] if age >= 16 & trimestre =="T4", over(PAT) 
mat list e(b)
...
/* Sexe */
mat RESU1_ = RESU1_ \ (.)
proportion sexe [pw=poids_men_vf] if age >= 16 & trimestre =="T4", over(PAT) 
mat list e(b)
...
/* Niveau d'Instruction */
mat RESU1_ = RESU1_ \ (.)
proportion Niv_inst_AG3 [pw=poids_men_vf] if age >= 16 & trimestre =="T4", over(PAT)
mat list e(b)
...
/* Ensemble */
proportion 1.PAT [pw=poids_men_vf] if trimestre =="T4"
mat list e(b)
...
/* Milieu de résidence */
proportion 1.PAT  [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2) 
mat list e(b)
mat RESU2_ = RESU2_ \ (e(b)* 100)'

/* Sexe */
mat RESU2_ = RESU2_ \ (.)
proportion 1.PAT [pw=poids_men_vf] if trimestre =="T4", over(sexe) 
mat list e(b)
mat RESU2_ = RESU2_ \ (e(b)* 100)'

/* Niveau d'Instruction */
mat RESU2_ = RESU2_ \ (.)
proportion 1.PAT [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU2_ = RESU2_ \ (e(b)* 100)'
...
mat RESU = RESU, RESU_, RESU2, RESU2_, RESU1, RESU1_
...
matrix colnames RESU = "Effectif T3" "Effectif T4" "(% profil ligne T3)" "(% profil ligne T4)" "(% profil colonne T3)" "(% profil colonne T4)"
...
/* Milieu de résidence */
total i.SU1 [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2) 
mat list e(b)
mat RESU1_ = RESU1_ \ (r(table)[rownumb(r(table),"b"),4..6])'

/* Sexe */
mat RESU1_ = RESU1_ \ (.)
total i.SU1 [pw=poids_men_vf] if trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU1_ = RESU1_ \ (r(table)[rownumb(r(table),"b"),3..4]')

/*Groupe d'Age */
mat RESU1_ = RESU1_ \ (.)
total i.SU1 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
mat RESU1_ = RESU1_ \ (r(table)[rownumb(r(table),"b"),5..8] )'

/* Niveau d'instruction */
mat RESU1_ = RESU1_ \ (.)
total i.SU1 [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU1_ = RESU1_ \ (r(table)[rownumb(r(table),"b"),6..10])'

/* Ensemble */
total i.SU1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
...
/* Milieu de résidence */
proportion 1.SU1 [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(milieu_resid2) 
mat list e(b)
...
/* Sexe */
mat RESU1_ = RESU1_ \ (.)
proportion 1.SU1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU1_ = RESU1_ \ e(b)'*100
...
/*Groupe d'Age */
mat RESU1_ = RESU1_ \ (.)
proportion 1.SU1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
mat RESU1_ = RESU1_ \ e(b)'*100

/* Niveau d'Instruction */
mat RESU1_ = RESU1_ \ (.)
proportion 1.SU1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU1_ = RESU1_ \ e(b)'*100

/* Ensemble */
proportion 1.SU1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU1_ = RESU1_ \ e(b)'*100
...
/* Milieu de résidence */
proportion milieu_resid2  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(SU1) 
mat list e(b)
mat RESU2_ = RESU2_ \ ((r(table)[rownumb(r(table),"b"),2] * 100),(r(table)[rownumb(r(table),"b"),4] * 100)',(r(table)[rownumb(r(table),"b"),6] * 100))'

/* Sexe */
mat RESU2_ = RESU2_ \ (.)
proportion sexe [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(SU1) 
mat list e(b)
mat RESU2_ = RESU2_ \ ((r(table)[rownumb(r(table),"b"),2] * 100),(r(table)[rownumb(r(table),"b"),4] * 100))'

/*Groupe d'Age */
mat RESU2_ = RESU2_ \ (.)
proportion groupe_age4 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(SU1)
mat list e(b)
...
/* Niveau d'Instruction */
mat RESU2_ = RESU2_ \ (.)
proportion Niv_inst_AG3 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(SU1)
mat list e(b)
...
/* Ensemble */
proportion SU1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU2_ = RESU2_ \ ((r(table)[rownumb(r(table),"b"),2] * 100)')

/* Fusion des deux colonnes */

mat RESU = RESU, RESU_, RESU1, RESU1_, RESU2, RESU2_
...
/* Milieu de résidence */
proportion milieu_resid2  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(`SU') 
mat list e(b)
mat RESU_`i' = RESU_`i' \ ((r(table)[rownumb(r(table),"b"),2] * 100),(r(table)[rownumb(r(table),"b"),4] * 100)',(r(table)[rownumb(r(table),"b"),6] * 100))'

/* Sexe */
mat RESU_`i' = RESU_`i' \ (.)
proportion sexe [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(`SU') 
mat list e(b)
mat RESU_`i' = RESU_`i' \ ((r(table)[rownumb(r(table),"b"),2] * 100),(r(table)[rownumb(r(table),"b"),4] * 100))'

/*Groupe d'Age */
mat RESU_`i' = RESU_`i' \ (.)
proportion groupe_age4 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(`SU')
mat list e(b)
...
/* Niveau d'Instruction */
mat RESU_`i' = RESU_`i' \ (.)
proportion Niv_inst_AG3 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(`SU')
mat list e(b)
...
/* Ensemble */
proportion `SU' [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
...
mat RESU_colonne = RESU_1,RESU_2,RESU_3,RESU_4,RESU1,RESU2,RESU3,RESU4
...
/* Milieu de résidence */
proportion 1.`SU' [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(milieu_resid2) 
mat list e(b)
mat RESU_`i' = RESU_`i' \ e(b)'*100

/* Sexe */
mat RESU_`i' = RESU_`i' \ (.)
proportion 1.`SU' [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU_`i' = RESU_`i' \ e(b)'*100

/*Groupe d'Age */
mat RESU_`i' = RESU_`i' \ (.)
proportion 1.`SU' [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(groupe_age4)
mat list e(b)
mat RESU_`i' = RESU_`i' \ e(b)'*100

/* Niveau d'Instruction */
mat RESU_`i' = RESU_`i' \ (.)
proportion 1.`SU' [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU_`i' = RESU_`i' \ e(b)'*100

/* Ensemble */
proportion 1.`SU' [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU_`i' = RESU_`i' \ e(b)'*100
}
...
mat RESU_ligne = RESU_5,RESU_6,RESU_7,RESU_8,RESU5,RESU6,RESU7,RESU8

****Matrice sous_utilisation finale

mat RESU= RESU5,RESU1,  RESU_5,RESU_1, RESU6,RESU2,  RESU_6,RESU_2, RESU7,RESU3, RESU_7,RESU_3, RESU8,RESU4, RESU_8,RESU_4
...
matrix colnames RESU = "(% Profil Ligne T3)" "(% Profil Colonne T3)" "(% Profil Ligne T4)" "(% Profil Colonne T4)" "(% Profil Ligne T3)" "(% Profil Colonne T3)" "(% Profil Ligne T4)" "(% Profil Colonne T4)" "(% Profil Ligne T3)" "(% Profil Colonne T3)"  "(% Profil Ligne T4)" "(% Profil Colonne T4)" "(% Profil Ligne T3)" "(% Profil Colonne T3)" "(% Profil Ligne T4)" "(% Profil Colonne T4)"   
...
putexcel D3="Taux de chômage T4"
...
/* Milieu de résidence */
proportion emp_vul  [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(milieu_resid2) 
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),4..6] * 100)')

/* Sexe */
mat RESU_ = RESU_ \ (.)
proportion emp_vul [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),3..4] * 100)')

/*Groupe d'Age */
mat RESU_ = RESU_ \ (.)
proportion emp_vul [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),5..8] * 100)')

/* Niveau d'Instruction */
mat RESU_ = RESU_ \ (.)
proportion emp_vul [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),6..10] * 100)')


/* Ensemble */
proportion emp_vul [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
...
matrix colnames RESU = "Pourcentage (%) T3" "Pourcentage (%) T4"
...
/* Milieu de résidence */
proportion form_empEP  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(milieu_resid2) 
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1..3] * 100)',(r(table)[rownumb(r(table),"b"),4..6] * 100)')

/* Sexe */
mat RESU_ = RESU_ \ (.,.) 
proportion form_empEP [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1..2] * 100)',(r(table)[rownumb(r(table),"b"),3..4] * 100)')

/*Groupe d'Age */
mat RESU_ = RESU_ \ (.,.)
proportion form_empEP [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1..4] * 100)',(r(table)[rownumb(r(table),"b"),5..8]* 100)')

/* Niveau d'Instruction */
mat RESU_ = RESU_ \ (.,.)
proportion form_empEP [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1..5] * 100)',(r(table)[rownumb(r(table),"b"),6..10]* 100)')


/* Ensemble */
proportion form_empEP [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1] * 100)',(r(table)[rownumb(r(table),"b"),2]* 100)')

mat RESU = RESU[1..19,1], RESU_[1..19,1], RESU[1..19,2], RESU_[1..19,2]
...
matrix colnames RESU = "Emploi Informel T3" "Emploi Informel T4" "Emploi Formel T3" "Emploi Formel T4"
...
/* Milieu de résidence */
proportion MO  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(milieu_resid2) 
mat list e(b)
matrix list r(table)
/*
matrix part1 = r(table)[rownumb(r(table), "b"), 1..3] * 100
...
/* Sexe */
mat RESU_ = RESU_ \ (.,.)
proportion MO [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
matrix list r(table)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1..2] * 100)',(r(table)[rownumb(r(table),"b"),3..4] * 100)')
...
/*Groupe d'Age */
mat RESU_ = RESU_ \ (.,.)
proportion MO [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
matrix list r(table)
...
/* Niveau d'Instruction */
mat RESU_ = RESU_ \ (.,.)
proportion MO [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1..4] * 100)',(r(table)[rownumb(r(table),"b"),5..8]* 100)')
...
/* Ensemble */
proportion MO [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1] * 100)',(r(table)[rownumb(r(table),"b"),2]* 100)')

matrix list RESU_

mat RESU = RESU[1..18,1], RESU_[1..18,1] , RESU[1..18,2], RESU_[1..18,2]
...
matrix colnames RESU = "Population en emploi T3"  "Population en emploi T4"   "Population au chômage T3" "Population au chômage T4"
...
/* Milieu de résidence */
proportion statut_MO  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(milieu_resid2) 
mat list e(b)
matrix list r(table)
...
/* Sexe */
mat RESU_ = RESU_ \ (.,.,.)
proportion statut_MO [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
matrix list r(table)
...
/*Groupe d'Age */
mat RESU_ = RESU_ \ (.,.,.)
proportion statut_MO [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
matrix list r(table)
...
/* Niveau d'Instruction */
mat RESU_ = RESU_ \ (.,.,.)
proportion statut_MO [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1..4] * 100)',(r(table)[rownumb(r(table),"b"),5..8]* 100)',(r(table)[rownumb(r(table),"b"),9..12]* 100)')
...
/* Ensemble */
proportion statut_MO [pw=poids_men_vf] if age >= 16 & trimestre == "T4"
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),1] * 100)',(r(table)[rownumb(r(table),"b"),2]* 100)',(r(table)[rownumb(r(table),"b"),3]* 100)')

matrix list RESU_

mat RESU = RESU[1..18,1], RESU_[1..18,1], RESU[1..18,2], RESU_[1..18,2] , RESU[1..18,3], RESU_[1..18,3]
...
matrix colnames RESU = "Population en emploi T3" "Population en emploi T4" "Population au chomage T3"  "Population au chomage T4" "Population hors main d'oeuvre T3" "Population hors main d'oeuvre T4"
...
/* Milieu de résidence */
proportion MOPOT_bis  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(milieu_resid2) 
mat list e(b)
mat RESU_ = RESU_ \ ((r(table)[rownumb(r(table),"b"),4..6] * 100)')
...
proportion MOPOT_bis  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
...
/*Groupe d'Age */
mat RESU_ = RESU_ \ (.)
proportion MOPOT_bis  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4) 
...
/* Niveau d'Instruction */
mat RESU_ = RESU_ \ (.)
proportion MOPOT_bis  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG2) 
...
/* Ensemble */
proportion MOPOT_bis  [pw=poids_men_vf] if age >= 16 & trimestre == "T4"
...
matrix colnames RESU = "Main d'oeuvre potentielle T3" "Main d'oeuvre potentielle T4"
...
proportion NEET15_24_bis [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table), "b"), 4..6] * 100)')

total NEET15_24 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
...
mat RESU_1 = RESU_1 \ (.)
mat RESU_2 = RESU_2 \ (.)
proportion sexe  [pw=poids_men_vf] if trimestre =="T4", over(NEET15_24)  

proportion NEET15_24_bis [pw=poids_men_vf] if trimestre =="T4", over(sexe) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),3..4] * 100)')


total NEET15_24 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table),"b"),1..2])')

/* Groupe d'age 6 */
mat RESU_1 = RESU_1 \ (.)
proportion NEET15_24_bis [pw=poids_men_vf] if trimestre =="T4", over(groupe_age6) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),3..4] * 100)')
mat RESU_1 = RESU_1 \ (.)
mat RESU_1 = RESU_1 \ (.)
...
/* Niveau d'Instruction */
mat RESU_1 = RESU_1 \ (.)
proportion NEET15_24_bis [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),5..8] * 100)')

mat RESU_2 = RESU_2 \ (.)
total NEET15_24 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
...
/* Ensemble */
proportion 1.NEET15_24_bis [pw=poids_men_vf] if trimestre =="T4"
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table), "b"), 1] * 100)')

total 1.NEET15_24 [pw=poids_men_vf] if trimestre =="T4"
mat list e(b)
...
proportion NEET15_35_bis [pw=poids_men_vf] if trimestre=="T4", over(milieu_resid2)
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table), "b"), 4..6] * 100)')


mat define RESU_2 = (.)
total NEET15_35 [pw=poids_men_vf] if trimestre=="T4", over(milieu_resid2)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table), "b"), 1..3])')

/* Sexe */
mat RESU_1 = RESU_1 \ (.)
proportion NEET15_35_bis [pw=poids_men_vf] if trimestre=="T4", over(sexe) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),3..4] * 100)')

mat RESU_2 = RESU_2 \ (.)
total NEET15_35 [pw=poids_men_vf] if trimestre=="T4", over(sexe)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table),"b"),1..2])')

/* Groupe d'age 6 */
mat RESU_1 = RESU_1 \ (.)
proportion 1.NEET15_35_bis [pw=poids_men_vf] if trimestre=="T4", over(groupe_age6) 
mat list e(b)
...
mat RESU_2 = RESU_2 \ (.)
total 1.NEET15_35 [pw=poids_men_vf] if trimestre=="T4", over(groupe_age6)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table),"b"),1..4])')
mat RESU_2 = RESU_2 \ (.)
mat RESU_2 = RESU_2 \ (.)
...
/* Niveau d'Instruction */
mat RESU_1 = RESU_1 \ (.)
proportion NEET15_35_bis [pw=poids_men_vf] if trimestre=="T4", over(Niv_inst_AG2) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),5..8] * 100)')

mat RESU_2 = RESU_2 \ (.)
total NEET15_35 [pw=poids_men_vf] if trimestre=="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table),"b"),1..4])')


/* Ensemble */
proportion 1.NEET15_35_bis if trimestre=="T4" [pw=poids_men_vf]
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table), "b"), 1] * 100)')

total 1.NEET15_35 [pw=poids_men_vf] if trimestre=="T4"
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table), "b"), 1])')
mat RESU_ =  RESU_2,RESU_1
...
/* Milieu de Résidence */
mat define RESU_1 = (.)
proportion NEET15_40_bis [pw=poids_men_vf] if trimestre=="T4", over(milieu_resid2)
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table), "b"), 4..6] * 100)')

mat define RESU_2 = (.)
total NEET15_40 [pw=poids_men_vf] if trimestre=="T4", over(milieu_resid2)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table), "b"), 1..3])')
...
proportion NEET15_40_bis [pw=poids_men_vf] if trimestre=="T4", over(sexe) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),3..4] * 100)')

mat RESU_2 = RESU_2 \ (.)

total NEET15_40 [pw=poids_men_vf] if trimestre=="T4", over(sexe)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table),"b"),1..2])')

/* Groupe d'age 7 */
mat RESU_1 = RESU_1 \ (.)
proportion 1.NEET15_40_bis [pw=poids_men_vf] if trimestre=="T4", over(groupe_age7) 
mat list e(b)
...
mat RESU_2 = RESU_2 \ (.)
total 1.NEET15_40 [pw=poids_men_vf] if trimestre=="T4", over(groupe_age7)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table),"b"),1..3])')
mat RESU_2 = RESU_2 \ (.)
...
/* Niveau d'Instruction */
mat RESU_1 = RESU_1 \ (.)
proportion NEET15_40_bis [pw=poids_men_vf] if trimestre=="T4", over(Niv_inst_AG2) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),5..8] * 100)')

mat RESU_2 = RESU_2 \ (.)
total NEET15_40 [pw=poids_men_vf] if trimestre=="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table),"b"),1..4])')

/* Ensemble */
proportion 1.NEET15_40_bis [pw=poids_men_vf] if trimestre=="T4"
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table), "b"), 1] * 100)')

total 1.NEET15_40 [pw=poids_men_vf] if trimestre=="T4"
mat list e(b)
mat RESU_2 = RESU_2 \ ((r(table)[rownumb(r(table), "b"), 1])')
mat RESU_ =  RESU_2,RESU_1
...
mat RESU_Def = RESU_Def[1..20,1], RESU__Def[1..20,1], RESU_Def[1..20,2], RESU__Def[1..20,2], RESU_Def[1..20,3], RESU__Def[1..20,3], RESU_Def[1..20,4], RESU__Def[1..20,4], RESU_Def[1..20,5], RESU__Def[1..20,5], RESU_Def[1..20,6], RESU__Def[1..20,6]
...
/* Statut socio professionnel */
proportion emp_prec [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(cat_profEP) 
mat list e(b)
...
/* Milieu de résidence*/
mat RESU_ = RESU_ \ (.)
proportion emp_prec [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(milieu_resid2) 
mat list e(b)
mat RESU_ = RESU_ \ (r(table)[rownumb(r(table),"b"),4..6] * 100)'
mat RESU_ = RESU_ \ (.)
...
/* Milieu de résidence*/
mat RESU_ = RESU_ \ (.)
proportion emp_prec [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG2) 
mat list e(b)
mat RESU_ = RESU_ \ (r(table)[rownumb(r(table),"b"),5..8] * 100)'
mat RESU_ = RESU_ \ (.)
...
/*Branche d'activité // A reactiver quand les données seront codifier 
mat RESU_ = RESU_ \ (.)
proportion 1.emp_prec [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(branche1) 
mat list e(b)
...
matrix colnames RESU = "Emploi précaire T3 (%)" "Emploi précaire T4 (%) "
...
/* Milieu de résidence */
total 1.pluriactivite [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2) 
mat list e(b)
...
/* Sexe */
mat RESU_ = RESU_ \ (.)
total 1.pluriactivite [pw=poids_men_vf] if trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU_ = RESU_ \ (r(table)[rownumb(r(table),"b"),1..2]')

/*Groupe d'Age */
mat RESU_ = RESU_ \ (.)
total 1.pluriactivite [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
mat RESU_ = RESU_ \ (r(table)[rownumb(r(table),"b"),1..4] )'

/* Niveau d'instruction */
mat RESU_ = RESU_ \ (.)
total 1.pluriactivite [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU_ = RESU_ \ (r(table)[rownumb(r(table),"b"),1..5])'

/* Ensemble */
total 1.pluriactivite [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
...
/* Milieu de résidence */
proportion milieu_resid2  [pw=poids_men_vf] if age >= 16 &  trimestre == "T4", over(pluriactivite) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),2] * 100),(r(table)[rownumb(r(table),"b"),4] * 100)',(r(table)[rownumb(r(table),"b"),6] * 100))'

/* Sexe */
mat RESU_1 = RESU_1 \ (.)
proportion sexe [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(pluriactivite) 
mat list e(b)
mat RESU_1 = RESU_1 \ ((r(table)[rownumb(r(table),"b"),2] * 100),(r(table)[rownumb(r(table),"b"),4] * 100))'

/*Groupe d'Age */
mat RESU_1 = RESU_1 \ (.)
proportion groupe_age4 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(pluriactivite)
mat list e(b)
...
/* Niveau d'Instruction */
mat RESU_1 = RESU_1 \ (.)
proportion Niv_inst_AG3 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(pluriactivite)
mat list e(b)
...
/* Ensemble */
proportion pluriactivite [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
...
/* Milieu de résidence */
proportion 1.pluriactivite [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(milieu_resid2) 
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b)* 100)'

/* Sexe */
mat RESU_2 = RESU_2 \ (.)
proportion 1.pluriactivite [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b)* 100)'

/*Groupe d'Age */
mat RESU_2 = RESU_2 \ (.)
proportion 1.pluriactivite [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b)* 100)'

/* Niveau d'Instruction */
mat RESU_2 = RESU_2 \ (.)
proportion 1.pluriactivite [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b)* 100)'

/* Ensemble */
proportion 1.pluriactivite [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b)* 100)'

/* Fusion des deux colonnes */

mat RESU = RESU, RESU_, RESU2, RESU_2 ,RESU1, RESU_1
...
**T4
mat define RESU_1 = (.)
proportion sit_empEP_Autorite [pw=poids_men_vf] if pop_emp_dich==1 & trimestre == "T4"
...
mat define RESU_2 = (.)
total 1.pop_emp [pw=poids_men_vf] if trimestre == "T4", over(sit_empEP_Autorite)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b))'

mat RESU = RESU2, RESU_2, RESU1, RESU_1
...
matrix colnames RESU = "Effectif T3" "Effectif T4" "% Categorie T3" "% Categorie T4"
...
mat define RESU_1 = (.)
proportion 1.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat define RESU_2 = (.)
proportion 2.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat define RESU_3 = (.)
proportion 3.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'
	
mat define RESU_4 = (.)
proportion 4.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'

mat define RESU_5 = (.)
proportion 5.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'

mat RESU_4 = RESU_4 \ (.)
proportion 4.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'
	
mat RESU_5 = RESU_5 \ (.)
proportion 5.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_5 = RESU_5 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'

mat RESU_4 = RESU_4 \ (.)
proportion 4.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'
	
mat RESU_5 = RESU_5 \ (.)
proportion 5.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_5 = RESU_5 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'

mat RESU_4 = RESU_4 \ (.)
proportion 4.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'

mat RESU_5 = RESU_5 \ (.)
proportion 5.CISE_18_new [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_5 = RESU_5 \ (e(b) * 100)' */
	
/* Consolidation de la matrice finale */
mat RESU = RESU1, RESU_1, RESU2, RESU_2, RESU3, RESU_3, RESU4, RESU_4, RESU5, RESU_5
...
matrix colnames RESU = "Employeur T3" "Employeur T4" "indépendants sans employ T3" "indépendants sans employ T4"  "Entrepreneurs Non-salar dépe T3" "Entrepreneurs Non-salar dépe T4" "Employés T3" "Employés T4" "Travailleurs familiaux T3" "Travailleurs familiaux T4"
...
mat RESU1 = RESU1 \ (.)
proportion 1.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU1 = RESU1 \ (e(b) * 100)'

mat RESU2 = RESU2 \ (.)
proportion 2.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU2 = RESU2 \ (e(b) * 100)'

mat RESU3 = RESU3 \ (.)
proportion 3.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU3 = RESU3 \ (e(b) * 100)'

mat RESU4 = RESU4 \ (.)
proportion 4.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU4 = RESU4 \ (e(b) * 100)'

mat RESU5 = RESU5 \ (.)
proportion 5.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU5 = RESU5 \ (e(b) * 100)'


mat RESU6 = RESU6 \ (.)
proportion 6.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU6 = RESU6 \ (e(b) * 100)'


mat RESU7 = RESU7 \ (.)
proportion 7.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU7 = RESU7 \ (e(b) * 100)'


mat RESU8 = RESU8 \ (.)
proportion 8.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU8 = RESU8 \ (e(b) * 100)'


mat RESU9 = RESU9 \ (.)
proportion 9.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU9 = RESU9 \ (e(b) * 100)'

mat RESU10 = RESU10 \ (.)
proportion 10.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T3", over(branche2)
mat list e(b)
mat RESU10 = RESU10 \ (e(b) * 100)' */
...
mat define RESU_1 = (.)
proportion 1.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat define RESU_2 = (.)
proportion 2.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat define RESU_3 = (.)
proportion 3.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'
	
mat define RESU_4 = (.)
proportion 4.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'

mat define RESU_5 = (.)
proportion 5.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_5 = RESU_5 \ (e(b) * 100)'

mat define RESU_6 = (.)
proportion 6.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_6 = RESU_6 \ (e(b) * 100)'

	
mat define RESU_7 = (.)
proportion 7.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_7 = RESU_7 \ (e(b) * 100)'
	
	
mat define RESU_8 = (.)
proportion 8.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_8 = RESU_8 \ (e(b) * 100)'
	

	mat define RESU_9 = (.)
proportion 9.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
mat RESU_9 = RESU_9 \ (e(b) * 100)'

	
mat define RESU_10 = (.)
proportion 10.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(sexe)
mat list e(b)
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'

mat RESU_4 = RESU_4 \ (.)
proportion 4.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'
	
mat RESU_5 = RESU_5 \ (.)
proportion 5.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_5 = RESU_5 \ (e(b) * 100)'
	
	
mat RESU_6 = RESU_6 \ (.)
proportion 6.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_6 = RESU_6 \ (e(b) * 100)'
	
	
mat RESU_7 = RESU_7 \ (.)
proportion 7.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_7 = RESU_7 \ (e(b) * 100)'
...
mat RESU_8 = RESU_8 \ (.)
proportion 8.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_8 = RESU_8 \ (e(b) * 100)'
	
	
mat RESU_9 = RESU_9 \ (.)
proportion 9.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_9 = RESU_9 \ (e(b) * 100)'
	
	
mat RESU_10 = RESU_10 \ (.)
proportion 10.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(milieu_resid2)
mat list e(b)
mat RESU_10 = RESU_10 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'

mat RESU_4 = RESU_4 \ (.)
proportion 4.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'
	
mat RESU_5 = RESU_5 \ (.)
proportion 5.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_5 = RESU_5 \ (e(b) * 100)'

mat RESU_6 = RESU_6 \ (.)
proportion 6.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_6 = RESU_6 \ (e(b) * 100)'

	
mat RESU_7 = RESU_7 \ (.)
proportion 7.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_7 = RESU_7 \ (e(b) * 100)'

	
mat RESU_8 = RESU_8 \ (.)
proportion 8.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_8 = RESU_8 \ (e(b) * 100)'


mat RESU_9 = RESU_9 \ (.)
proportion 9.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_9 = RESU_9 \ (e(b) * 100)'


mat RESU_10 = RESU_10 \ (.)
proportion 10.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_10 = RESU_10 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'

mat RESU_4 = RESU_4 \ (.)
proportion 4.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_4 = RESU_4 \ (e(b) * 100)'

mat RESU_5 = RESU_5 \ (.)
proportion 5.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_5 = RESU_5 \ (e(b) * 100)'


mat RESU_6 = RESU_6 \ (.)
proportion 6.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_6 = RESU_6 \ (e(b) * 100)'


mat RESU_7 = RESU_7 \ (.)
proportion 7.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_7 = RESU_7 \ (e(b) * 100)'


mat RESU_8 = RESU_8 \ (.)
proportion 8.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_8 = RESU_8 \ (e(b) * 100)'


mat RESU_9 = RESU_9 \ (.)
proportion 9.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_9 = RESU_9 \ (e(b) * 100)'

mat RESU_10 = RESU_10 \ (.)
proportion 10.CISE_18_niv2 [pw=poids_men_vf] if trimestre =="T4", over(branche2)
mat list e(b)
mat RESU_10 = RESU_10 \ (e(b) * 100)' */

/* Consolidation de la matrice finale */
mat RESU = RESU1, RESU_1, RESU2, RESU_2, RESU3, RESU_3, RESU4, RESU_4, RESU5, RESU_5,RESU6, RESU_6, RESU7, RESU_7, RESU8, RESU_8, RESU9, RESU_9, RESU10, RESU_10
...
matrix colnames RESU =  "Employeur entreprise/société T3" "Employeur entreprise/société T4" "Travailleur indép ménage T3" "Travailleur indép ménage T4"  "Trav indép sans employés T3" "Trav indép sans employés T4" "Trav indép entrep familiales T3" "Trav indép entrep familiales T4" "Travailleur familiaux T3" " Travailleur familiaux T4" "Contractuel dépendant T3" "Contractuel dépendant T4" "Apprenti, stagiaire rémunéré T3" "Apprenti, stagiaire rémunéré T4" "Employé permanent T3" "Employé permanent T4" "Employé à durée déterminée T3" "Employé à durée déterminée T4" "Employé temp et occa T3" "Employé temp et occa T4"
...
mat define RESU_1 = (.)
proportion 1.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat define RESU_2 = (.)
proportion 2.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat define RESU_3 = (.)
proportion 3.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(sexe)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'

mat RESU_3 = RESU_3 \ (.)
proportion 3.CISE_18_informel [pw=poids_men_vf] if trimestre == "T4", over(branche2)
mat list e(b)
mat RESU_3 = RESU_3 \ (e(b) * 100)' */ 


/* Consolidation de la matrice finale */
mat RESU = RESU1, RESU_1, RESU2, RESU_2, RESU3, RESU_3
...
matrix colnames RESU =  "Secteur Formel T3" "Secteur Formel T4"  "Secteur Informel T3" "Secteur Informel T4" "Ménages T3" "Ménages T4"
...
mat RESU1 = RESU1 \ (.)
proportion 1.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T3" , over(branche2)
mat list e(b)
mat RESU1 = RESU1 \ (e(b) * 100)'

mat RESU2 = RESU2 \ (.)
proportion 2.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T3" , over(branche2)
mat list e(b)
mat RESU2 = RESU2 \ (e(b) * 100)' */
...
mat define RESU_1 = (.)
proportion 1.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(sexe)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat define RESU_2 = (.)
proportion 2.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(sexe)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(milieu_resid2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(milieu_resid2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(Niv_inst_AG2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)'
...
mat RESU_1 = RESU_1 \ (.)
proportion 1.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(branche2)
mat list e(b)
mat RESU_1 = RESU_1 \ (e(b) * 100)'

mat RESU_2 = RESU_2 \ (.)
proportion 2.CISE_18_informel_Emp [pw=poids_men_vf] if trimestre== "T4", over(branche2)
mat list e(b)
mat RESU_2 = RESU_2 \ (e(b) * 100)' */

/* Consolidation de la matrice finale */
mat RESU = RESU1, RESU_1, RESU2, RESU_2
...
matrix colnames RESU =  "Emploi Formel T3" "Emploi Formel T4" "Emploi Informel T3"  "Emploi Informel T4" 
...
/* Milieu de résidence */
total i.branche1 [pw=poids_men_vf] if trimestre == "T4", over(milieu_resid2) 
mat list e(b)
...
total i.branche1 [pw=poids_men_vf] if trimestre == "T4", over(sexe) 
mat list e(b)
...
/*Groupe d'Age */
mat RESU1_ = RESU1_ \ J(1,4,.)
total i.branche1 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4)
mat list e(b)
...
/* Niveau d'instruction */
mat RESU1_ = RESU1_ \ J(1,4,.)
total i.branche1 [pw=poids_men_vf] if trimestre == "T4", over(Niv_inst_AG3)
mat list e(b)
...
/* Ensemble */
mat RESU1_ = RESU1_ \ J(1,4,.)
total i.branche1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
...
**T4
/* Milieu de résidence */
proportion 1.branche1 [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(milieu_resid2) 
mat define RESU1_ = e(b)'*100

proportion 2.branche1 [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(milieu_resid2) 
mat RESU1_ = RESU1_, e(b)'*100

proportion 3.branche1 [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(milieu_resid2) 
mat RESU1_ = RESU1_, e(b)'*100

proportion 4.branche1 [pw=poids_men_vf] if age >= 16 & trimestre == "T4" , over(milieu_resid2) 
mat RESU1_ = RESU1_, e(b)'*100
...
/* Sexe */
proportion 1.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat define RESU1__S = e(b)'*100

proportion 2.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU1__S = RESU1__S, e(b)'*100

proportion 3.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU1__S = RESU1__S, e(b)'*100


proportion 4.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(sexe) 
mat list e(b)
mat RESU1__S = RESU1__S, e(b)'*100
...
/*Groupe d'Age */
proportion 1.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4) 
mat list e(b)
mat define RESU1__GrpeAge = e(b)'*100

proportion 2.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4) 
mat list e(b)
mat RESU1__GrpeAge = RESU1__GrpeAge, e(b)'*100

proportion 3.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4) 
mat list e(b)
mat RESU1__GrpeAge = RESU1__GrpeAge, e(b)'*100


proportion 4.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(groupe_age4) 
mat list e(b)
mat RESU1__GrpeAge = RESU1__GrpeAge, e(b)'*100
...
/* Niveau d'Instruction */
proportion 1.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3) 
mat list e(b)
mat define RESU1__NivInst = e(b)'*100

proportion 2.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3) 
mat list e(b)
mat RESU1__NivInst = RESU1__NivInst, e(b)'*100

proportion 3.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3) 
mat list e(b)
mat RESU1__NivInst = RESU1__NivInst, e(b)'*100


proportion 4.branche1  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(Niv_inst_AG3) 
mat list e(b)
mat RESU1__NivInst = RESU1__NivInst, e(b)'*100
...
/* Ensemble */
proportion 1.branche1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat define RESU1__Ens = e(b)'*100

proportion 2.branche1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU1__Ens = RESU1__Ens, e(b)'*100

proportion 3.branche1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU1__Ens = RESU1__Ens, e(b)'*100

proportion 4.branche1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
mat RESU1__Ens = RESU1__Ens, e(b)'*100
...
/* Milieu de résidence */
proportion milieu_resid2  [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(branche1) 
mat list e(b)
...
proportion sexe [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(branche1) 
mat list e(b)
mat RESU2_ = RESU2_ \ ((r(table)[rownumb(r(table),"b"),1..4] * 100)',(r(table)[rownumb(r(table),"b"),5..8] * 100)')'

/*Groupe d'Age */
mat RESU2_ = RESU2_ \ J(1,4,.)
proportion groupe_age4 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(branche1)
mat list e(b)
...
/* Niveau d'Instruction */
mat RESU2_ = RESU2_ \ J(1,4,.)
proportion Niv_inst_AG3 [pw=poids_men_vf] if age >= 16 & trimestre == "T4", over(branche1)
mat list e(b)
...
/* Ensemble */
mat RESU2_ = RESU2_ \ J(1,4,.)
proportion branche1 [pw=poids_men_vf] if trimestre == "T4"
mat list e(b)
...
mat RESU = RESU[1...,1], RESU_[1...,1], RESU1[1...,1], RESU1_[1...,1], RESU2[1...,1], RESU2_[1...,1],  RESU[1...,2], RESU_[1...,2], RESU1[1...,2], RESU1_[1...,2], RESU2[1...,2], RESU2_[1...,2],  RESU[1...,3], RESU_[1...,3], RESU1[1...,3], RESU1_[1...,3], RESU2[1...,3], RESU2_[1...,3],  RESU[1...,4], RESU_[1...,4], RESU1[1...,4], RESU1_[1...,4], RESU2[1...,4], RESU2_[1...,4]
...
matrix colnames RESU = "Effectif T3" "Effectif T4" "(% Profil Ligne T3)" "(% Profil Ligne T4)" "(% Profil Colonne T3)" "(% Profil Colonne T4)" "Effectif T3" "Effectif T4" "(% Profil Ligne T3)" "(% Profil Ligne T4)" "(% Profil Colonne T3)" "(% Profil Colonne T4)" "Effectif T3" "Effectif T4" "(% Profil Ligne T3)" "(% Profil Ligne T4)" "(% Profil Colonne T3)" "(% Profil Colonne T4)" "Effectif T3" "Effectif T4" "(% Profil Ligne T3)" "(% Profil Ligne T4)" "(% Profil Colonne T3)" "(% Profil Colonne T4)"
...
*En tête des branches
putexcel B4 = "Effectif T3"
putexcel (B4:E4), merge

putexcel F4 =  "Effectif T4"
putexcel (F4:I4), merge

putexcel J4 = "(% Profil Ligne T3)"
putexcel (J4:M4), merge

putexcel N4 = "(% Profil Ligne T4)"
putexcel (N4:Q4), merge

putexcel R4 = "(% Profil Colonne T3)"
putexcel (R4:U4), merge

putexcel V4 = "(% Profil Colonne T4)"
