...
########      - POPULATION FIGURES AT THE REGIONAL LEVEL, BY URBAN/RURAL, SEX AND 3 AGE GROUPS   ( X49 TO X444) ########.   ########.
########                                                                                                        ########.
########################################################################################################################.
########################################################################################################################.
########################################################################################################################.
...
POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR <- read_xlsx(FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_XLSX)
# POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR <- read_dta(FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_DTA)

#  View(POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR)
...
save(POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR,file = FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_RDATA)
...
tmp_sum_pop_fig1 <-
  sum(POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR$Nombre)
tmp_sum_pop_fig1
