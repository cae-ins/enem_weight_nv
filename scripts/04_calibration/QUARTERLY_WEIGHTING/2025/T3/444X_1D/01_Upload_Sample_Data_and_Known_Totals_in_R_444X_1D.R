...
POP_LFS_BY_REGION_SEX_3AGEGR <- read_xlsx(FILE_POP_LFS_BY_REGION_SEX_3AGEGR_XLSX)
...
save(POP_LFS_BY_REGION_SEX_3AGEGR,file = FILE_POP_LFS_BY_REGION_SEX_3AGEGR_RDATA)
...
tmp_sum_pop_fig1 <-
  sum(POP_LFS_BY_REGION_SEX_3AGEGR$Nombre)/2
tmp_sum_pop_fig1
