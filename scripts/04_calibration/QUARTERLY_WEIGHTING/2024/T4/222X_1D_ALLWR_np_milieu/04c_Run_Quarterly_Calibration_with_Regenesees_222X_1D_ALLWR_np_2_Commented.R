...
load("LFS_SAMPLE_DATA_2024_T4_222X_1D_ALLWR_np.RData")
...
load("LFS_KNOWN_TOTALS_2024_T4_222X_1D_ALLWR_np.RData")
...
sum(rowSums( known_totals[, seq(2,223) ] ))
...
constrains_x <- constraints_model(222)
...
###  Check the total of the known total population 
sum(rowSums( popdataframe[, seq(2,223) ] ))
...
save(LFS_CALIBRATION_FINAL_WEIGHTS, file="LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_FINAL_WEIGHTS.RData")
...
save(LFS_CALIBRATION_SUMMARY_OF_DESIGN_WEIGHTS, file="LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_SUMMARY_OF_DESIGN_WEIGHTS.RData")

write.csv(LFS_CALIBRATION_SUMMARY_OF_DESIGN_WEIGHTS, file="LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_SUMMARY_OF_DESIGN_WEIGHTS.csv")
...
save(LFS_CALIBRATION_SUMMARY_OF_FINAL_CORR_FACTOR, file="LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_SUMMARY_OF_CORR_FACTORS.RData")

write.csv(LFS_CALIBRATION_SUMMARY_OF_FINAL_CORR_FACTOR, file="LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_SUMMARY_OF_CORR_FACTORS.csv")
...
save(LFS_CALIBRATION_SUMMARY_OF_FINAL_WEIGHTS, file="LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_SUMMARY_OF_FINAL_WEIGHTS.RData")

write.csv(LFS_CALIBRATION_SUMMARY_OF_FINAL_WEIGHTS, file="LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_SUMMARY_OF_FINAL_WEIGHTS.csv")
