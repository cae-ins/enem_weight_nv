...
library(readxl)
POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR <- read_excel(paste0(root,"Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR_corrige.xlsx"))
POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR
...
save(POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR,file=paste0(root,"/Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR_corrige.RData"))
