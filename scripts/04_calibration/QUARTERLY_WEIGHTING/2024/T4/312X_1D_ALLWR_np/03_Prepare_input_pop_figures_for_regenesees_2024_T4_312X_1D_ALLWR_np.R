...
load(file=paste0(root,"Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR_corrige.RData"))

### Check that the dataframe "POP_LFS_BY_REGION_SEX_14AGEGR" has been loaded


str(POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR)


View(POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR)
...
tmpKT <- POP_LFS_BY_REGION_SEX_MILIEU_2AGEGR
...
tmpKT <- cbind( tmpKT , data.frame(matrix(0 , nrow = nrow(tmpKT), ncol =  312, byrow = FALSE)))
...
save(LFS_KNOWN_TOTALS, file="LFS_KNOWN_TOTALS_2024_T4_312X_1D_ALLWR_np.RData")
...
sum(LFS_KNOWN_TOTALS[,seq(2,313)])
...
LFS_KNOWN_TOTALS_TOT_POP_FIGURES$X_TOT <- rowSums(LFS_KNOWN_TOTALS_TOT_POP_FIGURES[,seq(2,313)])
...
colSums( LFS_KNOWN_TOTALS_TOT_POP_FIGURES[,seq(2,314)])

### lets add an additional element at the beginning

c("Total",colSums( LFS_KNOWN_TOTALS_TOT_POP_FIGURES[,seq(2,314)] ))
...
save(LFS_KNOWN_TOTALS_TOT_POP_FIGURES, file="LFS_KNOWN_TOTALS_2024_T4_312X_1D_ALLWR_np_TOT_POP_FIGURES.RData")
...
write_xlsx(LFS_KNOWN_TOTALS_TOT_POP_FIGURES,
          "LFS_KNOWN_TOTALS_2024_T4_312X_1D_ALLWR_np_TOT_POP_FIGURES.xlsx" )
