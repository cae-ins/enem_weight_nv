...
load("LFS_CALIBRATION_2024_T4_312X_1D_ALLWR_np_FINAL_WEIGHTS.RData")
...
write_xlsx(LFS_ILO_CAL,
           "LFS_CALIBRATION_2024_T4_312X_1D_ALLWR_np.xlsx" )
...
save.image("LFS_CALIBRATION_2024_T4_312X_1D_ALLWR_np_IMAGE.RData")
