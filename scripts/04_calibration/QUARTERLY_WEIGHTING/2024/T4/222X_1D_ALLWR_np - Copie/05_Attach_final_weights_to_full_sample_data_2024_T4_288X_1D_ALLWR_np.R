...
########              - Population by region, sex and 3 age groups    (X1 TO X222)                              ########.
########                                                                                                        ########.
########################################################################################################################.
########################################################################################################################.
...
write_xlsx(LFS_ILO_CAL,"LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np.xlsx")
######################################################################################################
###  
###   STEP 5.4 
###  
...
# load("LFS_CALIBRATION_2024_T4_222X_1D_ALLWR_np_IMAGE.RData")
