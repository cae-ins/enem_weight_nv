...
library(readxl)
POP_LFS_BY_REGION_SEX_14AGEGR <- read_excel(paste0(root,"Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_14AGEGR_corrige.xlsx"))
...
save(POP_LFS_BY_REGION_SEX_14AGEGR,file=paste0(root,"/Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_14AGEGR_corrige.RData"))
