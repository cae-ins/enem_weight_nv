...
load("LFS_CALIBRATION_2024_T4_8X_33D_ALLWR_np_FINAL_WEIGHTS.RData")
...
LFS_ILO_DER$INDKEY    <- as.factor(paste0(LFS_ILO_DER$interview__key, "-", LFS_ILO_DER$membres__id))
...
save.image("LFS_CALIBRATION_2024_T4_8X_33D_ALLWR_np_IMAGE.RData")

# load("LFS_CALIBRATION_2024_T4_8X_33D_ALLWR_np_IMAGE.RData")
