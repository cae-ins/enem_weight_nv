...
library(readxl)
POP_LFS_BY_REGION_SEX_3AGEGR <- read_excel(paste0(root,"Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_3AGEGR_corrige.xlsx"))
POP_LFS_BY_REGION_SEX_3AGEGR
...
save(POP_LFS_BY_REGION_SEX_3AGEGR,file=paste0(root,"/Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_3AGEGR_corrige.RData"))
