...
LFS_ILO_DER <- read_dta("D:/DOCUMENTS/CAE/Calibration/Applications ENEM/DATA/DERIVED_VARIABLES/2024/T4/base_finale_ind_menage_wcal.dta")
...
### We have 21 811 observations (individual interviews successfully completed) and 718 variables
...
save(LFS_ILO_DER ,file="D:/DOCUMENTS/CAE/Calibration/Applications ENEM/DATA/DERIVED_VARIABLES/2024/T4/LFS_ILO_2024_T4_DER.RData")
...
library(readxl)
POP_LFS_BY_REGION_SEX_14AGEGR <- read_excel("D:/DOCUMENTS/CAE/Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_14AGEGR.xlsx")
POP_LFS_BY_REGION_SEX_14AGEGR
...
save(POP_LFS_BY_REGION_SEX_14AGEGR,file="D:/DOCUMENTS/CAE/Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_14AGEGR.RData")
