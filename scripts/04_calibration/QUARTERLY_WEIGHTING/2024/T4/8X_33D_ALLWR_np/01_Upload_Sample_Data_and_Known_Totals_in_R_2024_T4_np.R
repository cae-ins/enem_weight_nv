...
library(readxl)
POP_LFS_BY_REGION_SEX_4AGEGR <- read_excel("D:/DOCUMENTS/CAE/Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_4AGEGR.xlsx")
POP_LFS_BY_REGION_SEX_4AGEGR
...
save(POP_LFS_BY_REGION_SEX_4AGEGR,file="D:/DOCUMENTS/CAE/Calibration/Applications ENEM/DATA/POPULATION_ESTIMATES/2024/T4/POP_LFS_BY_REGION_SEX_4AGEGR.RData")
