...
FILE_POP_LFS_BY_REGION_SEX_2AGEGR_CSV  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_2AGEGR_",year,"_T",quarter,".csv")
FILE_POP_LFS_BY_REGION_SEX_2AGEGR_CSV

FILE_POP_LFS_BY_REGION_SEX_2AGEGR_XLSX  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_2AGEGR_",year,"_T",quarter,".xlsx")
FILE_POP_LFS_BY_REGION_SEX_2AGEGR_XLSX

FILE_POP_LFS_BY_REGION_SEX_2AGEGR_DTA  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_2AGEGR_",year,"_T",quarter,".dta")
FILE_POP_LFS_BY_REGION_SEX_2AGEGR_DTA

###  Let's parameterize the name and path of the RData file with the population figures 

FILE_POP_LFS_BY_REGION_SEX_2AGEGR_RDATA  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_2AGEGR_",year,"_T",quarter,".RData")
...
R_SCRIPT_X_FORMATS <- "C:/Users/f.migone/Desktop/ENE_SURVEY_WEIGHTS/scripts/04_calibration/QUARTERLY_WEIGHTING/2025/T1/312X_1D/04f_XFormats_312X_1D.R"
R_SCRIPT_X_FORMATS
