...
########    "W:/ILO_LFS_GSBPM/PROG/565_QUARTERLY_WEIGHTING/2021/Quarter1/444X_1D_ALLWR/                         ########.
########                                                                                                        ########.
########    The outputs of the procedure (both R objects and Excel files) will be stored in the folder          ########.
########    "W:/ILO_LFS_GSBPM/DATA/565_QUARTERLY_WEIGHTING/2021/Quarter1/444X_1D_ALLWR/                         ########.                                              
...
### "W:/2023_ILO_ITC_WEIGHTING/LFS_GSBPM_SW/DATA/560_POPULATION_ESTIMATES/2021/Quarter1/POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_2021_Q1.csv"


FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_CSV  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_",year,"_T",quarter,".csv")
FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_CSV

FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_XLSX  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_",year,"_T",quarter,".xlsx")
FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_XLSX

FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_DTA  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_",year,"_T",quarter,".dta")
FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_DTA

###  Let's parameterize the name and path of the RData file with the population figures 

FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_RDATA  <- paste0(dir_data_PE,"POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_",year,"_T",quarter,".RData")
FILE_POP_LFS_BY_REGION_URBAIN_RURAL_SEX_3AGEGR_RDATA
