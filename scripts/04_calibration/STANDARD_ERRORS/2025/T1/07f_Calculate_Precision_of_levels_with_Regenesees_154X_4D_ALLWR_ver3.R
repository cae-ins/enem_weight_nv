...
tmp_cvs_URRU_SEX <-  tmp_cvs_URRU_SEX[order(tmp_cvs_URRU_SEX$UR_RU,
                                            tmp_cvs_URRU_SEX$SEX),]
...
tmp_cvs_REG_URRU_SEX <-  tmp_cvs_REG_URRU_SEX[order(tmp_cvs_REG_URRU_SEX$REGION,
                                                    tmp_cvs_REG_URRU_SEX$UR_RU,
                                                    tmp_cvs_REG_URRU_SEX$SEX),]
tmp_cvs_REG_URRU_SEX 
...
tmp_cvs_ALL    	 <-  rbindlist(list(	 tmp_cvs_TOT,
                                       tmp_cvs_SEX,
                                       tmp_cvs_AGE[tmp_cvs_AGE$AGE_GROUP12>1,],
                                       tmp_cvs_URRU,
                                       tmp_cvs_URRU_SEX,
                                       tmp_cvs_REG,
                                       tmp_cvs_REG_SEX,
...
write.csv(tmp_cvs_ALL, file = output_std_err_emp_levels_csv )
...
xl.workbook.open(FILE_Template_CVS_EMP_Levels_ver3_XLSX)


####################     SAVE WITH ANOTHER NAME IN A SPECIFIC FOLDER (CAN BE PARAMETERISED)     #####################

# xl.workbook.save(FILE_Table_CVS_EMPL_Levels_ver1_XLSX)
...
xl.write("Employment Level", celltitle)
...
xl.write(paste0(year," Quarter ", quarter), cellrefper )
...
xl.workbook.save(FILE_Table_CVS_EMPL_Levels_ver3_XLSX)
